...
function CommandBar({ view, onOpenPalette, onNav }) {
  ...
  return React.createElement('header', { className: 'mc-bar' },
    ...
    React.createElement('div', { className: 'mc-bar__right' },
      React.createElement('div', { className: 'mc-gauge-pill' },
        React.createElement('span', { className: 'lbl' }, 'Profile'),
        React.createElement('span', { className: 'val' }, window.MC.operator.profile)),
      React.createElement('div', { className: 'mc-gauge-pill' },
        React.createElement('span', { className: 'lbl' }, 'Context'),
        React.createElement('div', { className: 'mc-ctx' },
          React.createElement('div', { className: 'mc-ctx__track' }, React.createElement('div', { className: 'mc-ctx__fill', style: { width: '64%' } })),
          React.createElement('span', { className: 'val' }, '64%'))),
      React.createElement('div', { className: 'mc-gauge-pill' },
        React.createElement('span', { className: 'lbl' }, 'Spend'),
        React.createElement('span', { className: 'val gold' }, '$4.27')),
